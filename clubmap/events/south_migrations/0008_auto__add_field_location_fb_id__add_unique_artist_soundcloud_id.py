...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Artist', fields ['soundcloud_id']
        db.create_unique(u'events_artist', ['soundcloud_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Artist', fields ['soundcloud_id']
        db.delete_unique(u'events_artist', ['soundcloud_id'])
