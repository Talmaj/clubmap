...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Location.longitude'
        db.alter_column(u'events_location', 'longitude', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Location.latitude'
        db.alter_column(u'events_location', 'latitude', self.gf('django.db.models.fields.FloatField')(default=None))
