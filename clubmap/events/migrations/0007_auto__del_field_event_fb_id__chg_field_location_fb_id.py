...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_location', 'fb_id', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Location.fb_id'
        db.alter_column(u'events_location', 'fb_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=None, unique=True))
